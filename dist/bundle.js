...
class Tweets {
    constructor() {
        ...
        this.searchTotal = 0;
        this.isSearch = false;
        this.markerCluster = new MarkerClusterer(__WEBPACK_IMPORTED_MODULE_0__google_map___default.a, this.tweets.markers,
    ...
    openInfoWindow(infoWindow) {
        infoWindow.open(__WEBPACK_IMPORTED_MODULE_0__google_map___default.a, this.lastMarker);
...
var googleMapConfig = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__google_map_style__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__google_map_style___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__google_map_style__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__request_public_tweet__ = __webpack_require__(0);





for (let i in __WEBPACK_IMPORTED_MODULE_2__google_map_style___default.a.ids) {
    __WEBPACK_IMPORTED_MODULE_1__google_map___default.a.mapTypes.set(__WEBPACK_IMPORTED_MODULE_2__google_map_style___default.a.ids[i],
        new google.maps.StyledMapType(
            __WEBPACK_IMPORTED_MODULE_2__google_map_style___default.a[__WEBPACK_IMPORTED_MODULE_2__google_map_style___default.a.ids[i]], {name: __WEBPACK_IMPORTED_MODULE_2__google_map_style___default.a.ids[i]}));
...
__WEBPACK_IMPORTED_MODULE_0__vue___default.a.component('mid-control', {
    template: '\
    <div class="bg-info"> \
...
__WEBPACK_IMPORTED_MODULE_0__vue___default.a.component('bottom-control', {
    template: '\
    <div>\
    ...
    methods: {
        reset: ()=> {
            __WEBPACK_IMPORTED_MODULE_3__request_public_tweet__["a" /* default */].reset();
            x.distance = '';
            x.searchText = '';
            x.isSearchDis = false;
            x.isSearchText = false;
...
__WEBPACK_IMPORTED_MODULE_0__vue___default.a.component('top-right-control', {
    ...
    methods: {
        search: ()=> {
            __WEBPACK_IMPORTED_MODULE_3__request_public_tweet__["a" /* default */].search(x.searchText);
            x.isSearchText = true;
            x.isSearchDis = false;
            x.isSelectPoint = false;
        },
...
__WEBPACK_IMPORTED_MODULE_1__google_map___default.a.controls[google.maps.ControlPosition.TOP_CENTER].push(midControlDiv);
__WEBPACK_IMPORTED_MODULE_1__google_map___default.a.controls[google.maps.ControlPosition.BOTTOM_CENTER].push(bottomControlDiv);
__WEBPACK_IMPORTED_MODULE_1__google_map___default.a.controls[google.maps.ControlPosition.TOP_RIGHT].push(topRightControlDiv);
...
module.exports = {
    ids: ['Standard', 'Silver', 'Retro', 'Dark', 'Night', 'Aubergine'],
    Standard: [],
    Silver: [{
